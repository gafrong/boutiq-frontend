...
import BoutiqButton from "./StyledComponents/BoutiqButton"
...
const OrderCard = (props) => {
    ...
    useEffect(() => {
        ...
        if (props.status == "Pending" || props.status == "3") {
          setOrderStatus(<TrafficLight unavailable></TrafficLight>);
          setStatusText("pending");
          setCardColor("#E74C3C");
        } else if (props.status == "Shipped" || props.status == "2") {
    ...
    return (
        ...
        <View style={[{ backgroundColor: cardColor }, styles.container]}>
            ...
            <View style={styles.priceContainer}>
                <Text>Price: </Text>
                <Text style={styles.price}>{props.totalPrice}원</Text>
            </View>
            {props.editMode ? (
                <View>
                {/* <Picker
